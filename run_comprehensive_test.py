#!/usr/bin/env python3
"""
Comprehensive test runner for the chunked compression system
Tests all components with real LLM integration
"""
import torch
import numpy as np
from test_real_llm import ChunkedCompressionTester
import time
